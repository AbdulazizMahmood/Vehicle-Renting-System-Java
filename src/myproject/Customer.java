...
public class Customer extends Person implements Serializable{
    ...
    public Customer(int ID, int NumbersOfRentingDays, Date BookDate, Vehicle rentedCar, String CustomerMail, String Name, String Gender, String Address, String PhoneNumber) {
    ...
    public Customer(int ID, int NumbersOfRentingDays, Date BookDate, Vehicle rentedCar, String CustomerMail) {
        this.ID = ID;
        this.NumbersOfRentingDays = NumbersOfRentingDays;
        this.BookDate = BookDate;
        this.rentedCar = rentedCar;
